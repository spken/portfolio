      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-600 max-w-2xl mx-auto leading-relaxed">
            A passionate design student exploring the intersection of
            ...
            <div className="relative">
              ...
              <div className="relative p-8">
                ...
                <p className="text-gray-700 leading-relaxed mb-6">
                  ...
                  child, evolving into a deep appreciation for both traditional
                  and digital art forms. Currently pursuing my Bachelor's degree
                  in Design at Universidad Europea in Madrid since September
                  2024, I'm fascinated by the intersection of natural materials
                  like wood and digital mediums, constantly exploring how
                  tactile craftsmanship can merge with contemporary digital
                  design.
                </p>

                <p className="text-gray-700 leading-relaxed">
                  Through my studies at Universidad Europea, I've been
                  developing skills that bridge traditional art practices with
                  modern design principles. From wood design and sculpture to
                  digital illustration and painting, I believe in the power of
                  working across mediums to create authentic, meaningful design
                  solutions that connect people with both nature and technology.
                </p>
              </div>
            </div>
                ...
                <div className="space-y-4">
                  <div className="p-4 bg-white/70 rounded-xl backdrop-blur-sm shadow-sm hover:shadow-md transition-shadow duration-300">
                    ...
                    <p className="text-gray-500 text-xs">
                      Specializing in visual communication and contemporary
                      design practices
                    </p>
                  </div>
                </div>
              ...
              <div className="relative p-8">
                ...
                <div className="space-y-4">
                  <div className="p-4 bg-white/70 rounded-xl backdrop-blur-sm shadow-sm hover:shadow-md transition-shadow duration-300">
                    ...
                    <p className="text-gray-500 text-xs">
                      Exploring the intersection of traditional crafts, digital
                  ...
                  <div className="p-4 bg-white/70 rounded-xl backdrop-blur-sm shadow-sm hover:shadow-md transition-shadow duration-300">
                    ...
                    <p className="text-gray-500 text-xs">
                      Developing a personal style that bridges tactile and
                      digital mediums
                    </p>
                  </div>
                  <div className="p-4 bg-white/70 rounded-xl backdrop-blur-sm shadow-sm hover:shadow-md transition-shadow duration-300">
