      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-600 max-w-2xl mx-auto leading-relaxed">
            Ready to collaborate on meaningful projects and explore creative
            ...
            <div className="relative">
              ...
              <div className="relative p-8">
                ...
                <p className="text-gray-700 leading-relaxed mb-6">
                  I'm passionate about collaborating with creative minds and
                  bringing ideas to life through thoughtful design. Whether
                  you're a brand looking for a fresh visual identity, a
                  publication in need of compelling layouts, or simply someone
                  who shares a love for good design, I'd love to connect.
                </p>

                <p className="text-gray-700 leading-relaxed">
                  Currently studying Design at Universidad Europea in Madrid
                  since September 2024. I'm actively seeking opportunities to
                  contribute to meaningful projects while continuing to grow as
                  a designer. Available for freelance projects, internships, and
              ...
              <div className="relative p-8">
                ...
                >
                  ...
                  <p className="text-gray-600 text-sm leading-relaxed">
                    I'm always excited about new creative challenges and
                    learning opportunities. Whether you have a project idea,
                    internship opportunity, or just want to connect with a
                    fellow design enthusiast, I'd love to hear from you!
                  </p>
                </motion.div>
              </div>
            </div>
